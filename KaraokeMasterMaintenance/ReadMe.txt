================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : KaraokeMasterMaintenance プロジェクトの概要
===============================================================================

この KaraokeMasterMaintenance アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、KaraokeMasterMaintenance アプリケーションを構成する各ファイルの内容の概要が含まれています。

KaraokeMasterMaintenance.vcxproj
...
KaraokeMasterMaintenance.vcxproj.filters
...
KaraokeMasterMaintenance.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CKaraokeMasterMaintenanceApp アプリケーション クラスを宣言します。

KaraokeMasterMaintenance.cpp
    これはメインのアプリケーション ソース ファイルで、CKaraokeMasterMaintenanceApp アプリケーション クラスが含まれています。

KaraokeMasterMaintenance.rc
...
res\KaraokeMasterMaintenance.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル KaraokeMasterMaintenance.rc にインクルードされます。

res\KaraokeMasterMaintenance.rc2
...
KaraokeMasterMaintenanceDlg.h, KaraokeMasterMaintenanceDlg.cpp - ダイアログ
    これらのファイルには、CKaraokeMasterMaintenanceDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる KaraokeMasterMaintenance.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、KaraokeMasterMaintenance.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

KaraokeMasterMaintenance.manifest
